...
const OrderItemCard: React.FC<OrderItemCardProps> = ({ itemData }) => {
    return (
        <LinearGradient
            start={{ x: 0, y: 0 }}
            end={{ x: 1, y: 1 }}
            ...
            <View style={styles.CardInfoContainer}>
                <View style={styles.CardImageInfoContainer}>
                    <Image source={itemData.imagelink_square} style={styles.Image} />
                    <View>
                ...
                <View>
                    <Text style={styles.CardCurrency}>
                        $ <Text style={styles.CardPrice}>{itemData.ItemPrice}</Text>
                    </Text>
                </View>
            </View>
            ...
            {itemData.prices.map((data: Price, index: number) => (
                <View key={index.toString()} style={styles.CardTableRow}>
                    ...
                    <View style={styles.CardTableRow}>
                        ...
                        <Text style={styles.CardQuantityPriceText}>
                            $ {(data.quantity * data.price).toFixed().toString()}
                        </Text>
                    </View>
                </View>
            ))}
